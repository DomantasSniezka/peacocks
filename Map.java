...
public class Map {
    ...
    public static boolean isDoor(Coordinates currentPosition, Coordinates nextPosition) {
    ...
    public static boolean isValidMove(Coordinates startingPosition, String key) {
    ...
    public static String getValidMove(Coordinates startingPosition) {

        if (isValidMove(startingPosition, "u")) {
            return "u";
        }
        if (isValidMove(startingPosition, "d")) {
            return "d";
        }
        if (isValidMove(startingPosition, "l")) {
            return "l";
        }
        if (isValidMove(startingPosition, "r")) {
            return "r";
        }
